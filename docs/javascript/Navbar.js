    ...
    <nav class="fixed top-0 left-0 w-full bg-black z-40">
        <div class="max-w-7xl mx-auto flex justify-between items-center w-full lg:p-5 p-3 lg:h-24 h-20">
            ...
            <img src="/docs/assets/images/logo.png" class="lg:h-20 h-16" alt="logo">
                ...
                <img src="/docs/assets/images/logo-name-removebg-preview.png" class="lg:h-16 h-12 invert" alt="logo">
            </a>
            <div class="flex items-center gap-10">
                <div data-aos="fade-left" class="lg:flex items-center gap-10 hidden">
                    <ul  class="lg:flex hidden items-center text-zinc-300 gap-10">
                        ...
                        <li><a href="https://docs.google.com/document/d/1LroNEFxCBj-bf-5fWV56JliaFeEWIgnI60FIGr3JeEM/edit?usp=sharing" class="hover:text-[#f5e474] transition-all duration-500">Guía de transporte público
                            </a>
                        </li>
                    </ul>
                </div>
                <div data-aos="fade-left" class="lg:flex hidden items-center justify-center gap-2 relative">
                    ...
                    <!-- Dropdown -->
                    <div id="langDropdown" class="absolute fadeIn top-8 w-28 -left-2 bg-black text-zinc-300 p-3 rounded-xl shadow-lg hidden">
                        <ul class="space-y-3">
            ...
            <i data-aos="fade-left" id="mobileMenuBtn" class="fa-solid text-[#fff] fa-bars lg:!hidden text-2xl cursor-pointer mr-2"></i>
        </div>
    </nav>
    ...
    <div id="mobileMenu"
        ...
        <div class="p-6">
            <ul class="flex relative z-50 text-gray-300 flex-col gap-7">
                ...
                <li><a href="https://docs.google.com/document/d/1LroNEFxCBj-bf-5fWV56JliaFeEWIgnI60FIGr3JeEM/edit?usp=sharing"
                        class="hover:text-[#f5e474] mobileMenuCloseBtn text-nowrap transition-all duration-500">Guía de transporte público</a>
                </li>
            </ul>
