            ...
            <div class="flex items-center gap-10">
                <div data-aos="fade-left" class="lg:flex items-center gap-10 hidden">
                    <ul  class="lg:flex hidden items-center text-zinc-300 gap-10">
                        ...
                        <li><a href="https://docs.google.com/document/d/1LroNEFxCBj-bf-5fWV56JliaFeEWIgnI60FIGr3JeEM/edit?usp=sharing" class="hover:text-[#f5e474] transition-all duration-500">Guide to Public Transportation
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="p-6">
            <ul class="flex relative z-50 text-gray-300 flex-col gap-7">
                ...
                <li><a href="https://docs.google.com/document/d/1LroNEFxCBj-bf-5fWV56JliaFeEWIgnI60FIGr3JeEM/edit?usp=sharing"
                        class="hover:text-[#f5e474] mobileMenuCloseBtn text-nowrap transition-all duration-500">Guide to Public Transportation</a>
                </li>
            </ul>
